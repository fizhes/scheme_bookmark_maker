...
setTimeout(_ => {
  ...
  let board_data = board_ctx.getImageData(0, 0, 400, 400);
  let board_pix = board_data.data;
  let menu_data = menu_ctx.getImageData(0, 0, 400, 542);
  let menu_pix = menu_data.data;
    ...
    for(let y = 0; y < 542; y++) {
      for(let x = 0; x < 400; x++) {
        ...
        if(close(c, { r: 58, g: 145, b: 187, })) {
          ...
          menu_pix[1 + i] = sky.g;
          menu_pix[2 + i] = sky.b;
        } else if(close(c, { r: 135, g: 206, b: 250, }, 20)) {
  ...
  document.getElementById('save').onclick = function() {
    ...
    const score_bar = document.getElementById('score_bar').value || undefined;
    const border = document.getElementById('border').value || undefined;
    const background = document.getElementById('background').value || undefined;
    const shadows = document.getElementById('shadows').value || undefined;
    const light_squares = document.getElementById('light_squares').value || undefined;
    const dark_squares = document.getElementById('dark_squares').value || undefined;
    const light_goal = document.getElementById('light_goal').value || undefined;
    const dark_goal = document.getElementById('dark_goal').value || undefined;
    const key_block_marks = document.getElementById('key_block_marks').value || undefined;
    const sky = document.getElementById('sky').value || undefined;
